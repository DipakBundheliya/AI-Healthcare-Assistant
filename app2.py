...
def model_response(prompt,query_engine ):
  ...
  response = query_engine.query(assistant_prompt)
  response_text = str(response)  # Convert response to string
  return response_text 

def response_generator(prompt,query_engine ):
    response = model_response(prompt,query_engine)
